...
(function($, document) {
	var domBuffer = '<div class="nvui-dtpicker" data-type="datetime">\
		<div class="nvui-dtpicker-header">\
			<button data-id="btn-cancel" class="nvui-btn">取消</button>\
			<button data-id="btn-ok" class="nvui-btn nvui-btn-blue">确定</button>\
		</div>\
		<div class="nvui-dtpicker-title"><h5 data-id="title-y">年</h5><h5 data-id="title-m">月</h5><h5 data-id="title-d">日</h5><h5 data-id="title-h">时</h5><h5 data-id="title-i">分</h5></div>\
		<div class="nvui-dtpicker-body">\
			<div data-id="picker-y" class="nvui-listpicker">\
				<div class="nvui-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
			</div>\
			<div data-id="picker-m" class="nvui-listpicker">\
				<div class="nvui-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
			</div>\
			<div data-id="picker-d" class="nvui-listpicker">\
				<div class="nvui-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
			</div>\
			<div data-id="picker-h" class="nvui-listpicker">\
				<div class="nvui-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
			</div>\
			<div data-id="picker-i" class="nvui-listpicker">\
				<div class="nvui-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
